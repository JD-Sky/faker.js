...
function Faker (opts) {
  ...
  self.football = bindAll(new Football(self));

  var RugbyLeague = require('./rugbyleague');
  self.rugbyLeague = bindAll(new RugbyLeague(self));

  var RugbyUnion = require('./rugbyunion');
  self.rugbyUnion = bindAll(new RugbyUnion(self));
  ...
  var _definitions = {
    ...
    "title": "",
    "separator": "",
    "football": ["team", "venue", "competition"],
    "rugbyleague": ["team", "venue", "competition"],
    "rugbyunion": ["team", "venue", "competition"]
  };
